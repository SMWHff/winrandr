...
usage() {
    ...
    echo "  6. 推送 — git push origin main v<版本号>"
...
REPO=$(gh repo view --json nameWithOwner --jq .nameWithOwner 2>/dev/null || { echo "警告: 无法获取远程仓库信息，将使用默认值" >&2; echo "SMWHff/winrandr"; })
